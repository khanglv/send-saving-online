...
class Directive extends Component{
    ...
    render(){
        ...
        const lstTmpDateInterest = Object.keys(detailBond).length > 0 ? formula.GenDateInterestRate(formula.convertDateToEarlyDay(buyDate), detailBond.NGAYPH, detailBond.NGAYDH, detailBond.LOAI_TT, []) : null;
